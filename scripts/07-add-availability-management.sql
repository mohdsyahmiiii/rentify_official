-- Add comprehensive availability management system
...
-- Create function to check for overlapping availability blocks
CREATE OR REPLACE FUNCTION check_availability_block_overlap(
    p_item_id UUID,
    p_start_date DATE,
    p_end_date DATE,
...
BEGIN
    ...
    -- Check for owner availability blocks
